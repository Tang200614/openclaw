...
complete -c openclaw -n "__fish_seen_subcommand_from qa" -a "suite" -d 'Run all repo-backed QA scenarios against the real QA gateway lane'
...
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l provider-mode -d 'Provider mode: mock-openai or live-openai'
